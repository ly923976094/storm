...
public class MailCenterConstant {
    ...
    public final static String FROM_ADDRESS = "18537254716@163.com";
    public final static String USER = "18537254716@163.com";
    public final static String PWD = "1314520xnz";
}
